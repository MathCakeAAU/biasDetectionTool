...
promptTemplate = generatePrompt(False, False) # String template with 'age' and 'gender' variable
...
path = os.path.join(directory, f'gemini_3dot1_Flash_Lite_tariffs_experiment{counter}.csv')
